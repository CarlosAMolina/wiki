...
Primero, en la web del proveedor donde compramos el dominio ([OVH](https://www.ovh.com/) por ejemplo), en la configuración de la zona DNS añadimos un registro de tipo A, indicando el nombre del subdominio y el destino (la dirección IP).
